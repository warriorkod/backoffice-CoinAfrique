...
import { duration, relativeTimeThreshold, isMoment, unix, isDate, locale, utc, parseZone } from 'moment';
...
class TimeAgoPipe {
    ...
    createTimer() {
        ...
        this.currentTimer = this.ngZone.runOutsideAngular(() => {
            if (typeof window !== 'undefined') {
                return window.setTimeout(() => {
                    this.lastText = momentConstructor$a(this.lastValue).from(momentConstructor$a(), this.lastOmitSuffix);
