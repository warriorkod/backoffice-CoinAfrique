...
(function($, window) {
    ...
    $(document).ready(function() {
        ...
        var ksAnnonceSlideControl = $('.ks-annonce-slide-control');
        var ksAnnonceBisSlideControl = $('.ks-annonce-detail');
        var ksAnnonceSlideCloseControl = $('.ks-annonce-slide-close-control');
        ...
        ksAnnonceSlideControl.on('click', function() {
            $(this).closest('.ks-annonce-slide-block').toggleClass('ks-open');
        });

        ksAnnonceSlideCloseControl.on('click', function() {
            $(this).closest('.ks-annonce-slide-block').removeClass('ks-open');
        });

        ksAnnonceBisSlideControl.on('click', function() {
            $(this).closest('.ks-annonce-slide-block').toggleClass('ks-open');
        });
